...
% Function to adjust the rhs vector of the paraoli problem, in order to
% take into account the presence of the time dependent part of the forcing
% term
%
% Input:  b: original rhs vector, with bc already imposed
%         f_t: function handle, containing the time dependent expresion of
%         the forcing term
%         fespace: finite element space structure
%
% Output: b_adj: function handle (in time) containing the adjusted 
