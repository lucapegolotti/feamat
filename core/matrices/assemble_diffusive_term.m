function [A] = assemble_diffusive_term(fespace, mu)
    ...
    %           mu: diffusivity coefficient. It can be a scalar or a 2x2
    %           matrix, both constant and an anonymous function
    ...
    if(~ismatrix(mu))
        ...
        if(~isa(mu,'function_handle'))
            ...
            A = assemble_diffusive_term_component(fespace, 1, 1, mu11) + ...
                ...
                assemble_diffusive_term_component(fespace, 2, 1, mu12);
        end
    end
end